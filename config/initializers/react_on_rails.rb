...
ReactOnRails.configure do |config|
  ...
  # It is important to set this to "" if you are not doing server rendering to
  # avoid an extraneous log warning that the default file of server-bundle.js
  # does not exist.
  config.server_bundle_js_file =
    'app/assets/javascripts/generated/server-bundle.js' # This is the default
  ...
  # For server rendering. This can be set to false so that server side
